...
export const SERVICES: Service[] = [
  {
    ...
    price: 55,
    therapists: ['Jacques Batenga', 'Josué KASEREKA SHAMAMBA', 'Samuel KASEREKA MUSISIVA'],
  ...
  },
  {
    ...
    shortDescription: 'Suivi thérapeutique structuré et profond pour traiter des difficultés émotionnelles complexes ou des blocages persistants.',
    ...
    price: 55,
    therapists: ['Jacques Batenga', 'Samuel KASEREKA MUSISIVA'],
  ...
  },
  {
    ...
    shortDescription: 'Un espace de dialogue sécurisé pour aider les partenaires à mieux communiquer et retrouver une relation plus sereine.',
    fullDescription: 'Le thérapeute facilite la communication constructive et aide le couple à identifier les schémas répétitifs créant des tensions.',
    iconName: 'Heart',
    imageAlt: 'Conseil conjugal et thérapie de couple chez CAPSY',
    price: 70,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1609234656388-0ff363383899?auto=format&fit=crop&q=80&w=600'
  },
  {
    id: 'evaluation_enfants',
    title: 'Évaluation psychologique enfants/ados',
    shortDescription: 'Bilan et analyse complète du fonctionnement cognitif, émotionnel et comportemental de l’enfant ou de l’adolescent.',
    fullDescription: 'Elle aide à objectiver et comprendre l’origine des difficultés scolaires, comportementales ou psycho-affectives du jeune public.',
    iconName: 'Activity',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1484981138541-3d074aa97716?auto=format&fit=crop&q=80&w=600'
  },
  {
    id: 'evaluation_adultes',
    title: 'Évaluation psychologique adultes',
    shortDescription: 'Bilan complet du fonctionnement mental, émotionnel et cognitif de l’adulte avec rédaction de rapport.',
    fullDescription: 'Un rapport rigoureux et clair est fourni pour comprendre précisément la dynamique psychologique globale et orienter idéalement le traitement.',
    iconName: 'LineChart',
  ...
  },
  {
    ...
    shortDescription: 'Séances psycho-éducatives adaptées pour aider l’enfant à mieux réguler ses émotions et corriger ses comportements.',
    fullDescription: 'Méthodes interactives et ludiques basées sur l’expression créative pour améliorer l’équilibre affectif du jeune.',
  ...
  },
  {
    ...
    shortDescription: 'Soutien d’urgence immédiat destiné à une personne ayant subi un incident particulièrement choquant dans son cadre de vie ou de travail.',
    fullDescription: 'Intervention clinique rapide indispensable pour endiguer l’état de choc aigu et prévenir le développement d’un Trouble de Stress Post-Traumatique (TSPT).',
    iconName: 'LifeBuoy',
  ...
  },
  {
    ...
    shortDescription: 'Accompagnement éthique et clinique pour les psychologues praticiens désireux de parfaire leur technicité.',
    fullDescription: 'Un espace nécessaire d’analyse de la pratique, d’ajustement des postures et de précaution contre la fatigue de compassion clinique.',
    iconName: 'Sparkles',
