...
export default function Hero({ onOpenBooking, onOpenStressTest }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-36 lg:pb-24 bg-gradient-to-br from-white via-white to-blue-50/20" id="hero-section">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-brand-blue/5 rounded-b-full blur-3xl -z-10" />
      <div className="absolute bottom-0 left-0 w-1/4 h-1/3 bg-brand-green/5 rounded-r-full blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left" id="hero-text-container">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-blue/10 border border-brand-blue/15 shadow-2xs">
              <span className="flex h-2 w-2 rounded-full bg-brand-green animate-pulse" />
              <span className="text-[10px] sm:text-xs font-bold font-poppins text-brand-blue uppercase tracking-widest">
                Capsy Services — RDC
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-poppins font-black text-brand-blue leading-[1.125] tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-3.5 pt-2">
              <button
                ...
                className="py-3.5 px-7 bg-brand-green hover:bg-brand-green/95 text-white rounded-2xl text-base font-extrabold font-poppins flex items-center justify-center gap-3 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 cursor-pointer group"
              ...
              <button
                ...
                className="py-3.5 px-6 bg-brand-blue/10 hover:bg-brand-blue/15 text-brand-blue rounded-2xl text-sm font-bold font-poppins flex items-center justify-center gap-2 transition-all"
                id="hero-secondary-cta-btn"
              >
                <LucideIcon name="Sparkles" className="h-4.5 w-4.5 text-brand-green" />
            ...
            <div className="pt-6 border-t border-gray-100 grid grid-cols-3 gap-4">
              <div>
                <p className="text-xl sm:text-2xl font-bold font-poppins text-brand-blue">100%</p>
                <p className="text-[10px] text-brand-gray-text uppercase font-semibold tracking-wide">Confidentiel</p>
              </div>
              <div>
                <p className="text-xl sm:text-2xl font-bold font-poppins text-brand-blue">Goma</p>
                <p className="text-[10px] text-brand-gray-text uppercase font-semibold tracking-wide">Cabinet Medical</p>
              </div>
              <div>
                <p className="text-xl sm:text-2xl font-bold font-poppins text-brand-blue">Direct</p>
          ...
          <div className="lg:col-span-6 relative flex justify-center" id="hero-image-pane">
            <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-none">
              ...
              <div className="absolute inset-0 bg-brand-blue/10 rounded-3xl -rotate-3 scale-98" />
              ...
              <div className="absolute top-4 right-4 bg-brand-dark/90 backdrop-blur-xs text-white p-3 rounded-2xl flex items-center gap-2 shadow-md z-15 select-none animate-pulse">
                <LucideIcon name="Heart" className="h-4 w-4 text-brand-green" />
              ...
              <div className="absolute -bottom-6 -right-2 sm:-right-6 bg-white border border-brand-green/30 p-4 rounded-2xl shadow-xl max-w-[280px] z-20 flex gap-3 items-start select-none">
                <div className="p-1 bg-brand-green/10 rounded-full text-brand-green shrink-0 mt-1">
                ...
                <div>
                  <p className="text-xs text-brand-dark leading-relaxed italic font-medium font-sans">
                    « Parler à quelqu’un est souvent le premier pas vers le <span className="text-brand-green font-bold">mieux-être</span>. »
                  </p>
                </div>
              </div>
