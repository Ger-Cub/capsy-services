    ...
    <section className="py-20 bg-white" id="identite">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch mb-16">
          ...
          {/* Mission Card */}
          <div className="bg-gradient-to-br from-brand-wellbeing to-brand-wellbeing/90 rounded-2xl p-8 sm:p-10 text-white relative overflow-hidden flex flex-col justify-between shadow-md">
            ...
            <div className="pt-8 border-t border-white/10 mt-8 flex items-center gap-3.5 relative z-10 text-[11px] font-bold tracking-wider uppercase text-brand-darkgreen">
              <span>Soin</span>
          ...
          {/* Vision Card */}
          <div className="bg-brand-gray-light rounded-2xl p-8 sm:p-10 border border-gray-150 flex flex-col justify-between shadow-xs hover:border-brand-wellbeing transition-colors group">
            <div className="space-y-6">
              <div className="p-3.5 bg-brand-wellbeing/10 text-brand-wellbeing rounded-xl inline-block group-hover:bg-brand-wellbeing group-hover:text-white transition-colors">
                <LucideIcon name="Sparkles" className="h-7 w-7 text-brand-wellbeing group-hover:text-white" />
              </div>
              <div className="space-y-3">
